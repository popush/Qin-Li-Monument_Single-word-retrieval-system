...
def run_training():
    train_dir = r'C:\graduation_project\example'
    train_labelfile = r'C:\graduation_project\TRAIN_INFO.txt'
    logs_train_dir = r'C:\graduation_project\logs\train'
    val_dir = r'C:\graduation_project\checking'
    val_labelfile = r'C:\graduation_project\ORG_INFO.txt'
    logs_val_dir = r'C:\graduation_project\logs\val'
